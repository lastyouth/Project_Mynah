...
public class CustomLayoutSet extends RelativeLayout {
    ...
    protected Handler mhHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                //핸들링 1일때 할 것
                Log.d(TAG,"type 1 -> response : "+msg.obj);
            }

            if (msg.what == 2) {
                //핸들링 2일때 할 것
                Log.d(TAG,"type 2 -> response : "+msg.obj);
            }
    ...
    private TextView tvBusDirNameSC;
    private TextView tvBusNumNameSC; // 121버스
    ...
    private void initActionbarColorChange(Context context)
    {
...
//        ivSubwayImage.setScaleY((float) 0.7);
    ...
    private void initClickListener()
    {
        ...
        for(int i=1;i<size-1;i++)
        {
            ...
            f_list.get(i).setOnLongClickListener(new OnLongClickListener() {
                @Override
                public boolean onLongClick(View v) {
                    ...
                    switch ((int)v.getTag())
                    {
                        ...
                        case index_schedule: //일정
                            intent = new Intent(mContext, CalendarActivity.class);
                            mContext.startActivity(intent);
                            break;

                        case index_bus: //버스
                            intent = new Intent(mContext, BusSettingActivity.class);
                            mContext.startActivity(intent);
                            break;

                        case index_subway: //지하철
                            intent = new Intent(mContext, SubwaySettingActivity.class);
                            mContext.startActivity(intent);
                            break;
        ...
        llWeather.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                showView(index_weather);
            }
        });
        ...
        llSchedule.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                showView(index_schedule);
            }
        });
        ...
        llBus.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                showView(index_bus);
            }
        ...
        llSubway.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                showView(index_subway);
            }
        });
    ...
    private void initBusView() {
        ...
        tvBusDirNameSC = (TextView) findViewById(R.id.tvBusDirNameSC);
        tvBusNumNameSC = (TextView) findViewById(R.id.tvBusNumNameSC);
    ...
    private void updateWeatherType(int type)
    {
        ...
        //handler type 3 : 웨더 상태 업데이트용
        new AsyncHttpTask(mContext, GlobalVariable.WEB_SERVER_IP, mhHandler, jobj, 3, 0);
