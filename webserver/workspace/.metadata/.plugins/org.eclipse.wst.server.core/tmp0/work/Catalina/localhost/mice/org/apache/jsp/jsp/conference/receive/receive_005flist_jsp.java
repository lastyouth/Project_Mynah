 ...
 * Generated at: 2015-08-14 06:54:11 UTC
...
public final class receive_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 // 컨퍼런스 셀렉트 리스트
	...
	listIndex = totalCnt - (pageSize * (cpage));
      ...
      out.write("        board.message_id.value = \"\";\r\n");
      out.write("        board.target=\"_self\";\r\n");
      out.write("        board.action          = \"");
      out.print( request.getRequestURI() );
      out.write("\";\r\n");
      ...
      out.write("    function goDisplay(message_id) {\r\n");
      out.write("        board.message_id.value = message_id; \r\n");
      ...
      out.write("                    <th><div align=\"center\">발신자</div></th>\r\n");
