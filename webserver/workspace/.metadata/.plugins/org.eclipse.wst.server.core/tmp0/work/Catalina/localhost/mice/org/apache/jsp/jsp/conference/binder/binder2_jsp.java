 ...
 * Generated at: 2015-08-19 14:07:10 UTC
...
public final class binder2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
/*////////////////세션 관리//////////////////////////*/
 ...
 // 컨퍼런스 셀렉트 리스트
	...
	listIndex = totalCnt - (pageSize * (cpage));
      ...
      out.write("        board.binder_id.value = \"\";\r\n");
      out.write("        board.target=\"_self\";\r\n");
      out.write("        board.action          = \"");
      out.print( request.getRequestURI() );
      out.write("\";\r\n");
      ...
      out.write("    function goDisplay(binder_id) {\r\n");
      out.write("        board.binder_id.value = binder_id; \r\n");
      ...
      out.write("\t\t\t\t\t\t<li><a href=\"../agenda/agenda.html\">아젠다</a></li>\r\n");
      out.write("\t\t\t\t\t\t<li class=\"active\"><a href=\"#\">초록 조회</a></li>\r\n");
      ...
      out.write("\t\tdata-toggle=\"table\" data-search=\"true\" data-show-refresh=\"true\" data-show-toggle=\"true\" data-pagination=\"true\">\r\n");
      out.write("\t\t\t<thead>\r\n");
      out.write("\t\t\t\t<th><div align=\"center\">세션</div></th>\r\n");
