...
/*////////////////세션 관리//////////////////////////*/
    ...
    if (b_mode.equals("W"))
    	menu_link_url = "/jsp/admin/sponsor/sponsor_write.jsp";
    else if (b_mode == null || "".equals(b_mode) || b_mode.equals("L"))
    	menu_link_url = "/jsp/admin/sponsor/sponsor_list.jsp";
    else  if (b_mode.equals("R"))
    	menu_link_url = "/jsp/admin/sponsor/sponsor_read.jsp";
    else  if (b_mode.equals("M"))
    	menu_link_url = "/jsp/admin/sponsor/sponsor_write.jsp";
    
    String menu_name       = "스폰서 관리";
