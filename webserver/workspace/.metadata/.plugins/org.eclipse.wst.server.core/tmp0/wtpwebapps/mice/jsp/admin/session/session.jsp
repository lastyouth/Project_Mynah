...
/*////////////////세션 관리//////////////////////////*/
    ...
    if (b_mode.equals("W"))
    	menu_link_url = "/jsp/admin/session/session_write.jsp";
    else if (b_mode.equals("DW"))
        	menu_link_url = "/jsp/admin/session/session_detail_write.jsp";
    else if (b_mode == null || "".equals(b_mode) || b_mode.equals("L"))
    	menu_link_url = "/jsp/admin/session/session_list.jsp";
    else if (b_mode.equals("DL"))
    	menu_link_url = "/jsp/admin/session/session_detail_list.jsp";
    else  if (b_mode.equals("R"))
    	menu_link_url = "/jsp/admin/session/session_read.jsp";
    else  if (b_mode.equals("DR"))
    	menu_link_url = "/jsp/admin/session/session_detail_read.jsp";
    else  if (b_mode.equals("M"))
    	menu_link_url = "/jsp/admin/session/session_write.jsp";
    else  if (b_mode.equals("DM"))
    	menu_link_url = "/jsp/admin/session/session_detail_write.jsp";
    
    String menu_name       = "세션 관리";
