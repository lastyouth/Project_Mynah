...
<!--
    ...
    /* 읽기 페이지로 이동 */
    function goDisplay(schedule_id) {
        board.schedule_id.value = schedule_id; 
...
<form name="board" method="post">  
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        <td valign="top"><table width="100%" style="border:1px solid #d3d3d3;">
           <thead>
                    <th><div align="center">스케쥴날짜</div></th>
...
%>				
			<tr>
				<td align="center"><a href="javascript:goDisplay('<%=schedule_id%>');" class="skin"><%=conference_date%></a></td>
				<td align="center">
					<a href="javascript:goDisplay('<%=schedule_id%>');" class="skin"><%= !"".equals(start_time)?start_time.substring(0,2):""%>:<%= !"".equals(start_time)?start_time.substring(2,4):""%> ~  <%= !"".equals(end_time)?end_time.substring(0,2):""%>:<%= !"".equals(end_time)?end_time.substring(2,4):""%></a>
				</td>
				<td align="center">
					<a href="javascript:goDisplay('<%=schedule_id%>');" class="skin">
					<%=title%>
					</a>
				</td>
				<td align="center"><a href="javascript:goDisplay('<%=schedule_id%>');" class="skin"><%=reg_date%></a></td>
			</tr>
<%      } 
    }
    %> 
