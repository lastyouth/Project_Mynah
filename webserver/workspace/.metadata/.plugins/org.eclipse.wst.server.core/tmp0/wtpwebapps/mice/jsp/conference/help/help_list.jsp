...
<%
    ...
    parmValue.put("ORDER_BY"            , " help.reg_date desc   "      );     
 ...
 // 컨퍼런스 셀렉트 리스트
    ...
    rset = help.getHelpList(parmValue); 
   
    /*============= 2. 페이징 관련 셋팅 ================*/
    totalCnt  = help.getHelpTotalRow(parmValue);             // 총 게시물 갯수
...
%>				
			<tr>
				...
				<td align="center"><a href="javascript:goDisplay('<%=help_id%>');" class="skin"><%=("".equals(reply)? "미답변" : "답변완료")%></a></td>
