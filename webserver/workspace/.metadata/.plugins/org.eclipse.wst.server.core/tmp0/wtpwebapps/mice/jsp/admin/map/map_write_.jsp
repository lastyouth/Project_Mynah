...
<%
    ...
    if( !"".equals(conference_id)) {
        ...
        while( rset.next()){
        	...
        	map_1    = StringUtil.defaultIfEmpty(rset.getString("map_1"    ), "");
        	map_2    = StringUtil.defaultIfEmpty(rset.getString("map_2"    ), "");
        	map_3    = StringUtil.defaultIfEmpty(rset.getString("map_3"    ), "");
        	map_4    = StringUtil.defaultIfEmpty(rset.getString("map_4"    ), "");
        	map_5    = StringUtil.defaultIfEmpty(rset.getString("map_5"    ), "");
        	map_6    = StringUtil.defaultIfEmpty(rset.getString("map_6"    ), "");
        	map_7    = StringUtil.defaultIfEmpty(rset.getString("map_7"    ), "");
        	map_8    = StringUtil.defaultIfEmpty(rset.getString("map_8"    ), "");
        	map_9    = StringUtil.defaultIfEmpty(rset.getString("map_9"    ), "");
        	map_10    = StringUtil.defaultIfEmpty(rset.getString("map_10"    ), "");
        	map_11    = StringUtil.defaultIfEmpty(rset.getString("map_11"    ), "");
  ...
  //이미지 확장자 체크
	...
	attachFile = {
	          ...
	          add:function(){ // 파일필드 추가
	               ...
	               var title = document.all ? document.createElement('<input name="titles">') : document.createElement('input');
	               title.type = 'text';
	               title.name = 'titles';
	               title.size = '40';
    ...
    %> 
            ...
            <tr>
              ...
              <td width="574" style="padding-left:20px;">
              	...
              	<input type="text" name="titles" value="" size="40">
