...
/*////////////////세션 관리//////////////////////////*/
    ...
    if (b_mode.equals("W"))
    	menu_link_url = "/jsp/admin/conference/conference_write.jsp";
    else if (b_mode == null || "".equals(b_mode) || b_mode.equals("L"))
    	menu_link_url = "/jsp/admin/conference/conference_list.jsp";
    else  if (b_mode.equals("R"))
    	menu_link_url = "/jsp/admin/conference/conference_read.jsp";
    else  if (b_mode.equals("M"))
    	menu_link_url = "/jsp/admin/conference/conference_write.jsp";
    
    String menu_name       = "컨퍼런스 관리";
...
<div id="main-wrapper1">
    <div id="main-wrapper">
        ...
        <div id="left">
			...
			<script>
				leftMenuHandler('menu_2');
				leftMenuSelection(17,'');
			</script>
            <!--//메뉴 -->
        </div>
        <!--//왼쪽메뉴 -->    
