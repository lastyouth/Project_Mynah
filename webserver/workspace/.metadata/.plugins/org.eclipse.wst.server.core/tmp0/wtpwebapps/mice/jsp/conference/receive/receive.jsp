...
/*////////////////세션 관리//////////////////////////*/
    ...
    if (b_mode == null || "".equals(b_mode) || b_mode.equals("L"))
    	menu_link_url = "/jsp/conference/receive/receive_list.jsp";
    else  if (b_mode.equals("R"))
    	menu_link_url = "/jsp/conference/receive/receive_read.jsp";
    else  if (b_mode.equals("M"))
    	menu_link_url = "/jsp/conference/receive/receive_write.jsp";
    else  if (b_mode.equals("W"))
    	menu_link_url = "/jsp/conference/receive/receive_write.jsp";
    
    String menu_name       = "수신함";
