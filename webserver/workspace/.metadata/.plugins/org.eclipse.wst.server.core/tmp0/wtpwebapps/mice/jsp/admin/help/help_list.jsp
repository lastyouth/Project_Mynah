...
<%
    ...
    // 목록
    rset = help.getHelpAdminList(parmValue);
 
    /*============= 2. 페이징 관련 셋팅 ================*/
    totalCnt  = help.getHelpAdminTotalRow(parmValue);             // 총 게시물 갯수
...
<!--
    ...
    /* 읽기 페이지로 이동 */
    function goDisplay(help_id) {
        board.help_id.value = help_id; 
...
<%    
        ...
        while( rset.next()){
        	help_id       = StringUtil.defaultIfEmpty(rset.getString("help_id"   ), ""); 
...
%>				
			<tr>
				<td align="center"><a href="javascript:goDisplay('<%=help_id%>');" class="skin"><%=conference_name%></a></td>
				<td align="center">
					<a href="javascript:goDisplay('<%=help_id%>');" class="skin">
					<%=title%>
					</a>
				</td>
				<td align="center"><a href="javascript:goDisplay('<%=help_id%>');" class="skin"><%=writer%></a></td>
				<td align="center"><a href="javascript:goDisplay('<%=help_id%>');" class="skin"><%=reg_date%></a></td>
				<td align="center"><a href="javascript:goDisplay('<%=help_id%>');" class="skin"><%=worker_name%></a></td>
			</tr>
<%      } 
    }
    %> 
