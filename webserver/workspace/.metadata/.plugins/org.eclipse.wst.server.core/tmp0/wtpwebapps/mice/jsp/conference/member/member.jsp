...
/*////////////////세션 관리//////////////////////////*/
	...
	String menu_link_url = "/jsp/conference/member/member_write.jsp";
    ...
    if (b_mode.equals("W")){
    	menu_link_url = "/jsp/conference/member/member_write.jsp";
    	menu_name       = "회원 정보 수정";
    }else if (b_mode == null || "".equals(b_mode) || b_mode.equals("L")){
    	menu_link_url = "/jsp/conference/member/member_list.jsp";
    	menu_name       = "참가자 조회";
    }
