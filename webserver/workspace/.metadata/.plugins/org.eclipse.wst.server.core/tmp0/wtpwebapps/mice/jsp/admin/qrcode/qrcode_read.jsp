...
<!--
     ...
     * 게시물 수정
     */
    function goModifyForm (qrcode_id ) {        
        var frm = document.<%=formName%>;
        
        frm.qrcode_id.value = qrcode_id;
        frm.target="_self";
        frm.b_mode.value = "M";
        ...
        <td valign="top">
           <table border="0" cellpadding="0" cellspacing="0" style="border-top:2px solid #e0e0e0; border-bottom:2px solid #e0e0e0; width:784px;">
            <tr>
              ...
              <td width="574" style="padding-left:20px;"><%=qr_code%></td>
            </tr>		
            <tr>
              <td class="bbbg" style="padding-left:20px; font-weight:bold;">QR 이미지</td>
      ...
      <tr>
        <td height="50" align="center">
					 <a href="javascript:goList();"><img src="/dhsp/images/bt_list.gif" alt="목록" /></a>
                      <a href="javascript:goModifyForm('<%= qrcode_id %>');"><img src="<%=root_path%>/images/bt_modify.gif" alt="수정" /></a>                   
