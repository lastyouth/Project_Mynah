    ...
    try {	   
        if( isOk ) {
            if( "ins".equals(modeType)){
            	conference.conferenceInsert(parmValue);
            } else if( "mod".equals(modeType)){
            	conference.conferenceModify(parmValue);
            } else if( "del".equals(modeType)){  
            	conference.conferenceDeleteContents(parmValue);  
            }
        }
        
%>
<form name="frmBrd" action="conference_info.jsp" method="post">
</form>
