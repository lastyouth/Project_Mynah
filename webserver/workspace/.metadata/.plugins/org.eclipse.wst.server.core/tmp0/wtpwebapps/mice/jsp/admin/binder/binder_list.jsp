...
%>				
			<tr>
				<td align="center"><a href="javascript:goDisplay('<%=binder_id%>');" class="skin"><%=conference_name%></a></td>
				<td align="center"><a href="javascript:goDisplay('<%=binder_id%>');" class="skin"><%=writer%></a></td>
				...
				<td align="center"><a href="javascript:goDisplay('<%=binder_id%>');" class="skin"><%=reg_date%></a></td>
			</tr>
<%      } 
    }
    %> 
