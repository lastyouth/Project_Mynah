...
<%
    ...
    parmValue.put("ORDER_BY"            , " message.reg_date desc   "      );     
 ...
 // 컨퍼런스 셀렉트 리스트
    ...
    rset = message.getDispatchList(parmValue); 
   
    /*============= 2. 페이징 관련 셋팅 ================*/
    totalCnt  = message.getDispatchTotalRow(parmValue);             // 총 게시물 갯수
...
<!--
    ...
    /* 읽기 페이지로 이동 */
    function goDisplay(message_id) {
        board.message_id.value = message_id; 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        <td valign="top"><table width="100%" style="border:1px solid #d3d3d3;">
           <thead>
                    ...
                    <th><div align="center">발신자</div></th>
...
%>				
			<tr>
				<td align="center"><a href="javascript:goDisplay('<%=message_id%>');" class="skin"><%=message_type%></a></td>
				<td align="center"><a href="javascript:goDisplay('<%=message_id%>');" class="skin"><%=from_user_name%></a></td>
				<td align="center">
					<a href="javascript:goDisplay('<%=message_id%>');" class="skin">
					<%=title%>
					</a>
				</td>
				<td align="center"><a href="javascript:goDisplay('<%=message_id%>');" class="skin"><%=reply%></a></td>
				<td align="center"><a href="javascript:goDisplay('<%=message_id%>');" class="skin"><%=reg_date%></a></td>
			</tr>
<%      } 
    }
    %> 
