...
<!--
    ...
    /* 읽기 페이지로 이동 */
    function goDisplay(manufacturer_id) {
        board.manufacturer_id.value = manufacturer_id;
...
%>				
			<tr>
				<td align="center"><a href="javascript:goDisplay('<%=manufacturer_id%>');" class="skin"><%=conference_name%></a></td>
				<td align="center">
					<a href="javascript:goDisplay('<%=manufacturer_id%>');" class="skin">
					<%=manufacturer_name%>
					</a>
				</td>
				<td align="center"><a href="javascript:goDisplay('<%=manufacturer_id%>');" class="skin"><%=reg_date%></a></td>
				<td align="center"><a href="javascript:goDisplay('<%=manufacturer_id%>');" class="skin"><%=worker_name%></a></td>
			</tr>
<%      } 
    }
    %> 
