...
/*////////////////세션 관리//////////////////////////*/
    ...
    if (b_mode.equals("W"))
    	menu_link_url = "/jsp/admin/present/present_write.jsp";
    else if (b_mode == null || "".equals(b_mode) || b_mode.equals("L"))
    	menu_link_url = "/jsp/admin/present/present_list.jsp";
    else  if (b_mode.equals("R"))
    	menu_link_url = "/jsp/admin/present/present_read.jsp";
    else  if (b_mode.equals("M"))
    	menu_link_url = "/jsp/admin/present/present_write.jsp";
    
    String menu_name       = "선물 관리";
...
<% }%>      
        ...
        <div id="contents">
	        ...
	        <jsp:param name="present_id"		value="<%=present_id%>"      />
	      </jsp:include>    	
          <!--//테이블 -->	                  
      </div>    
        <!--//오른쪽메뉴 -->        
