...
<!--
     ...
     * 게시물 수정
     */
    function goModifyForm (agenda_id ) {        
        var frm = document.<%=formName%>;
        
        frm.agenda_id.value = agenda_id;
        frm.target="_self";
        frm.b_mode.value = "M";
      ...
      <tr>
        <td valign="top">
           <table border="0" cellpadding="0" cellspacing="0" style="border-top:2px solid #e0e0e0; border-bottom:2px solid #e0e0e0; width:784px;">
            ...
            <tr>
              <td class="bbbg" style="padding-left:20px; font-weight:bold;">등록자</td>
              <td style="padding-left:20px;"><%=worker%></td>
            </tr>
            <tr>
      ...
      <tr>
        <td height="50" align="center">
					 <a href="javascript:goList();"><img src="/dhsp/images/bt_list.gif" alt="목록" /></a>
                      <a href="javascript:goModifyForm('<%= agenda_id %>');"><img src="<%=root_path%>/images/bt_modify.gif" alt="수정" /></a>                   
