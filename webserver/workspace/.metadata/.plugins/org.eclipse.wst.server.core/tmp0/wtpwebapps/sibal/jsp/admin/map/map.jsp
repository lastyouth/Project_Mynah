...
/*////////////////세션 관리//////////////////////////*/
    ...
    if (b_mode.equals("W"))
    	menu_link_url = "/jsp/admin/map/map_write.jsp";
    else if (b_mode == null || "".equals(b_mode) || b_mode.equals("L"))
    	menu_link_url = "/jsp/admin/map/map_list.jsp";
    else  if (b_mode.equals("R"))
    	menu_link_url = "/jsp/admin/map/map_read.jsp";
    else  if (b_mode.equals("M"))
    	menu_link_url = "/jsp/admin/map/map_write.jsp";
    
    String menu_name       = "행사장맵 관리";
...
<% }%>      
        ...
        <div id="contents">
	        ...
	        <jsp:param name="map_id"		value="<%=map_id%>"      />
	      </jsp:include>    	
          <!--//테이블 -->	                  
      </div>    
        <!--//오른쪽메뉴 -->        
