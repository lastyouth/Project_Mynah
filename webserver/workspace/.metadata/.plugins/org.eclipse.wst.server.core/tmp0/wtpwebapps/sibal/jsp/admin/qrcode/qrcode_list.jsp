...
<%
    ...
    // 목록
    rset = qrcode.getQrcodeList(parmValue);

    /*============= 2. 페이징 관련 셋팅 ================*/
    totalCnt  = qrcode.getQrcodeTotalRow(parmValue);             // 총 게시물 갯수
...
<!--
    ...
    /* 읽기 페이지로 이동 */
    function goDisplay(qrcode_id) {
        board.qrcode_id.value = qrcode_id; 
      ...
      <tr>
        <td valign="top"><table width="100%" style="border:1px solid #d3d3d3;">
           <thead>
                    ...
                    <th><div align="center">QR 코드</div></th>
...
%>				
			<tr>
				<td align="center"><a href="javascript:goDisplay('<%=qrcode_id%>');" class="skin"><%=conference_name%></a></td>
				<td align="center">
					<a href="javascript:goDisplay('<%=qrcode_id%>');" class="skin">
					<%=qr_code%>
					</a>
				</td>
				<td align="center"><a href="javascript:goDisplay('<%=qrcode_id%>');" class="skin"><%=reg_date%></a></td>
				<td align="center"><a href="javascript:goDisplay('<%=qrcode_id%>');" class="skin"><%=worker_name%></a></td>
			</tr>
<%      } 
    }
    %> 
