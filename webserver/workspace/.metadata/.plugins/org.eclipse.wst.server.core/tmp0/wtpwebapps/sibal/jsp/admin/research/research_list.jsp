...
<%
    ...
    /*============= 2. 페이징 관련 셋팅 ================*/
    totalCnt  = research.getResearchTotalRow(parmValue);             // 총 게시물 갯수
...
<!--
    ...
    /* 읽기 페이지로 이동 */
    function goDisplay(research_id) {
        board.research_id.value = research_id; 
        board.b_mode.value       = "R";
       // board.target             = "_self";
        board.action             = "<%= request.getRequestURI() %>";
        board.submit();
      ...
      <tr>
        <td valign="top"><table width="100%" style="border:1px solid #d3d3d3;">
           <thead>
                    ...
                    <th><div align="center">설문명</div></th>
                    <th><div align="center">상태</div></th>
                    <th><div align="center">시작일</div></th>
                    <th><div align="center">종료일</div></th>
...
<%    
        ...
        while( rset.next()){
        	...
        	stat     = StringUtil.defaultIfEmpty(rset.getString("stat" ), "");
...
%>				
			<tr>
				<td align="center"><a href="javascript:goDisplay('<%=research_id%>');" class="skin"><%=conference_name%></a></td>
				<td align="center">
					<a href="javascript:goDisplay('<%=research_id%>');" class="skin">
					<%=title%>
					</a>
				</td>
				<td align="center"><a href="javascript:goDisplay('<%=research_id%>');" class="skin"><%=stat%></a></td>
				<td align="center"><a href="javascript:goDisplay('<%=research_id%>');" class="skin"><%=start_date%></a></td>
				<td align="center"><a href="javascript:goDisplay('<%=research_id%>');" class="skin"><%=end_date%></a></td>
				<td align="center"><a href="javascript:goDisplay('<%=research_id%>');" class="skin"><%=reg_date%></a></td>
				<td align="center"><a href="javascript:goDisplay('<%=research_id%>');" class="skin"><%=worker_name%></a></td>
			</tr>
<%      } 
    }
    %> 
