...
/*////////////////세션 관리//////////////////////////*/
    ...
    if (b_mode.equals("W"))
    	menu_link_url = "/jsp/admin/research/research_write.jsp";
    else if (b_mode == null || "".equals(b_mode) || b_mode.equals("L"))
    	menu_link_url = "/jsp/admin/research/research_list.jsp";
    else  if (b_mode.equals("R"))
    	menu_link_url = "/jsp/admin/research/research_read.jsp";
    else  if (b_mode.equals("M"))
    	menu_link_url = "/jsp/admin/research/research_write.jsp";
    
    String menu_name       = "설문 관리";
...
<% }%>      
        ...
        <div id="contents">
	        ...
	        <jsp:param name="research_id"		value="<%=research_id%>"      />
