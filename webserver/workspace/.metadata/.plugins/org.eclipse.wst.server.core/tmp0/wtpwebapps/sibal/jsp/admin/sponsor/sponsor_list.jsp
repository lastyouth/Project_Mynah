...
<%
    ...
    /*============= 2. 페이징 관련 셋팅 ================*/
    totalCnt  = sponsor.getSponsorTotalRow(parmValue);             // 총 게시물 갯수
...
<!--
    ...
    /* 읽기 페이지로 이동 */
    function goDisplay(sponsor_id) {
        board.sponsor_id.value = sponsor_id; 
      ...
      <tr>
        <td valign="top"><table width="100%" style="border:1px solid #d3d3d3;">
           <thead>
                    ...
                    <th><div align="center">로고</div></th>
                    <th><div align="center">스폰서</div></th>
            </thead>
            <tbody>
    		</tbody>
<%
...
<%    
        ...
        while( rset.next()){
        	...
        	sponsor_id     = StringUtil.defaultIfEmpty(rset.getString("sponsor_id" ), "");
%>				
			<tr>
				<td align="center"><a href="javascript:goDisplay('<%=sponsor_id%>');" class="skin"><%=conference_name%></a></td>
				<td align="center">
					<a href="javascript:goDisplay('<%=sponsor_id%>');" class="skin">
					<img src="/mice/upload/sponsor/<%=logo %>">
					</a>
				</td>
				<td align="center">
					<a href="javascript:goDisplay('<%=sponsor_id%>');" class="skin">
    ...
    %> 
      ...
      <tr>
        <td height="50" align="center" class="line_search"><select name="searchTarget">
            <option value="1" <%= "1".equals(searchTarget) ? "selected" : "" %> >스폰서</option>
          </select>
