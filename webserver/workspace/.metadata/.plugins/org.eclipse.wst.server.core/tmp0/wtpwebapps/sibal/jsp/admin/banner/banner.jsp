...
/*////////////////세션 관리//////////////////////////*/
    ...
    if (b_mode.equals("W"))
    	menu_link_url = "/jsp/admin/banner/banner_write.jsp";
    else if (b_mode == null || "".equals(b_mode) || b_mode.equals("L"))
    	menu_link_url = "/jsp/admin/banner/banner_list.jsp";
    else  if (b_mode.equals("R"))
    	menu_link_url = "/jsp/admin/banner/banner_read.jsp";
    else  if (b_mode.equals("M"))
    	menu_link_url = "/jsp/admin/banner/banner_write.jsp";
    
    String menu_name       = "광고 관리";
...
<% }%>      
        ...
        <div id="contents">
	        ...
	        <jsp:param name="banner_id"		value="<%=banner_id%>"      />
	      </jsp:include>    	
          <!--//테이블 -->	                  
      </div>    
        <!--//오른쪽메뉴 -->        
